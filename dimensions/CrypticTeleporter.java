...
public class CrypticTeleporter extends Teleporter
{
    ...
    public CrypticTeleporter(WorldServer par1WorldServer)
    {
    ...
    public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
    	...
    	if (this.worldServerInstance.provider.dimensionId != 22)
        {
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        this.worldServerInstance.setBlock(k1, l1, i2, flag ? ItemBlockHolder.RedBlock.blockID : 0);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlockId(k1, i2, l1) == ItemBlockHolder.CrypticPortal.blockID)
                        {
                            while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == ItemBlockHolder.CrypticPortal.blockID)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlockId(i - 1, j, k) == ItemBlockHolder.CrypticPortal.blockID)
            {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlockId(i, j, k - 1) == ItemBlockHolder.CrypticPortal.blockID)
            {
                j2 = 3;
            }
            ...
            for (k2 = -1; k2 <= 1; ++k2)
            {
                for (i3 = 1; i3 < 3; ++i3)
                {
                    for (l2 = -1; l2 < 3; ++l2)
                    {
                        ...
                        flag = l2 < 0;
                        //Dimension
                        this.worldServerInstance.setBlock(k3, j3, i4, flag ? ItemBlockHolder.RedBlock.blockID : 0);
                    }
                }
            }
        }
        ...
        for (k2 = 0; k2 < 4; ++k2)
        {
            for (i3 = 0; i3 < 4; ++i3)
            {
                for (l2 = -1; l2 < 4; ++l2)
                {
                    ...
                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? ItemBlockHolder.RedBlock.blockID : ItemBlockHolder.CrypticPortal.blockID, 0, 2);
                }
            }
