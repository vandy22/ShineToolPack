...
public class WorldGenEclipseTrees extends WorldGenerator implements IWorldGenerator
{
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 128)
        {
            ...
            else
            {
                ...
                if ((l1 == ItemBlockHolder.EGrass.blockID || l1 == ItemBlockHolder.EDirt.blockID) && par4 < 128 - l - 1)
                {
                    ...
                    for (i2 = par4 + l; i2 >= par4 + i1; --i2)
                    {
                        for (j2 = par3 - l2; j2 <= par3 + l2; ++j2)
                        {
                            ...
                            for (int i3 = par5 - l2; i3 <= par5 + l2; ++i3)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, j2, i2, i3, ItemBlockHolder.EclipseLeaves.blockID, 1);
                                }
                            }
                        }
                    ...
                    for (i2 = 0; i2 < l - 1; ++i2)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + i2, par5, ItemBlockHolder.EclipseLogs.blockID, 1);
                        }
                    }
