...
public class ShineChicken extends EntityChicken
{
    ...
    public ShineChicken(World par1World)
    {
        super(par1World);
        this.texture = "/mob/ShineChicken.png";
     ...
     */
    public ShineChicken spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new ShineChicken(this.worldObj);
    }
