...
public class ShinePig extends EntityPig
{
    /** AI task for player control. */
    private final EntityAIControlledByPlayer aiControlledByPlayer;

    public ShinePig(World par1World)
    {
        super(par1World);
        this.texture = "/mob/ShinePig.png";
     ...
     */
    public ShinePig spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new ShinePig(this.worldObj);
    }
