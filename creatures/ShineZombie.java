...
public class ShineZombie extends EntityZombie
{
    /**
    ...
    public ShineZombie(World par1World)
    {
        super(par1World);
        this.texture = "/mob/ShineZombie.png";
    ...
    {
        super.entityInit();
        this.getDataWatcher().addObject(23, Byte.valueOf((byte)0));
        this.getDataWatcher().addObject(24, Byte.valueOf((byte)0));
        this.getDataWatcher().addObject(25, Byte.valueOf((byte)0));
    }
    ...
    {
        return this.isVillager() ? "/mob/zombie_villager.png" : "/mob/ShineZombie.png";
    }
    ...
    protected void addRandomArmor()
    {
        ...
        if (this.rand.nextFloat() < (this.worldObj.difficultySetting == 3 ? 0.05F : 0.01F))
        {
            ...
            {
                this.setCurrentItemOrArmor(0, new ItemStack(Item.shovelStone));
            }
        }
    }
    ...
    public void onKillEntity(EntityLiving par1EntityLiving)
    {
        ...
        if (this.worldObj.difficultySetting >= 2 && par1EntityLiving instanceof EntityVillager)
        {
            ...
            ShineZombie entityzombie = new ShineZombie(this.worldObj);
