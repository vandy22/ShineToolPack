...
public class RenderShineSpider extends RenderLiving
{
    public RenderShineSpider()
    {
    ...
    protected int setSpiderEyeBrightness(EntitySpider par1EntitySpider, int par2, float par3)
    {
        ...
        {
            this.loadTexture("/mob/Shinespider_eyes.png");
            float f1 = 1.0F;
            GL11.glEnable(GL11.GL_BLEND);
            GL11.glDisable(GL11.GL_ALPHA_TEST);
            GL11.glBlendFunc(GL11.GL_ONE, GL11.GL_ONE);

            if (par1EntitySpider.isPotionApplicable(null))
            {
