...
public class ShineFire extends BlockFire
{
    ...
    {
        if (par1World.provider.dimensionId > 0 || par1World.getBlockId(par2, par3 - 1, par4) != ItemBlockHolder.BasicCube.blockID || !ItemBlockHolder.portal.tryToCreatePortal(par1World, par2, par3, par4))
        {
            if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !this.canNeighborBurn(par1World, par2, par3, par4))
            {
                par1World.setBlockToAir(par2, par3, par4);
        ...
        // -1 Is overworld
        //Make sure these are not equal too's!!!!
        if (par1World.provider.dimensionId != 20 || par1World.getBlockId(par2, par3 - 1, par4) != ItemBlockHolder.EclipseBlock.blockID || !ItemBlockHolder.EclipsePortal.tryToCreatePortal(par1World, par2, par3, par4))
        {
            if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !this.canNeighborBurn(par1World, par2, par3, par4))
            {
                par1World.setBlockToAir(par2, par3, par4);
        ...
        if (par1World.provider.dimensionId != 21 || par1World.getBlockId(par2, par3 - 1, par4) != ItemBlockHolder.RedBlock.blockID || !ItemBlockHolder.CrypticPortal.tryToCreatePortal(par1World, par2, par3, par4))
        {
                if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !this.canNeighborBurn(par1World, par2, par3, par4))
                {
                    par1World.setBlockToAir(par2, par3, par4);
