...
public class ShineCow extends EntityCow
{
    public ShineCow(World par1World)
    {
        super(par1World);
        this.texture = "/mob/ShineCow.png";
     ...
     */
    public ShineCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new ShineCow(this.worldObj);
    }
