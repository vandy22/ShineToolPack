package net.shinemod.creatures;
...
public class ShineSheep extends EntitySheep
{
    ...
    public ShineSheep(World par1World)
    {
        super(par1World);
        this.texture = "/mob/ShineSheep.png";
    ...
    public ShineSheep func_90015_b(EntityAgeable par1EntityAgeable)
    {
        ShineSheep entitysheep = (ShineSheep)par1EntityAgeable;
        ShineSheep entitysheep1 = new ShineSheep(this.worldObj);
    ...
    private int func_90014_a(EntityAnimal par1EntityAnimal, EntityAnimal par2EntityAnimal)
    {
        ...
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.field_90016_e, ((ShineSheep)par1EntityAnimal).worldObj);
        int k;
    ...
    {
        return 15 - ((ShineSheep)par1EntityAnimal).getFleeceColor();
    }
