...
public class EclipseWorldProvider extends WorldProvider
{
...
public void registerWorldChunkManager()
{
	...
	worldChunkMgr = new WorldChunkManagerHell(ItemBlockHolder.Eclipse, 1.0F, 0.0F); //Your Biome goes here
	this.hasNoSky = false;
}
...
{
	return new ChunkProviderEclipse(worldObj, worldObj.getSeed(), false);
}
