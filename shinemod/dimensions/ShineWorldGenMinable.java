...
public class ShineWorldGenMinable extends WorldGenerator
{
 private int minableBlockID;
 private int numberOfBlocks;

 public ShineWorldGenMinable(int i, int j)
 {
  minableBlockID = i;
  numberOfBlocks = j;
 }
            ...
            for(int k2 = i1; k2 <= l1; k2++)
            {
                ...
                for(int l2 = j1; l2 <= i2; l2++)
                {
                    ...
                    for(int i3 = k1; i3 <= j2; i3++)
                    {
                        ...
                        if(d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && world.getBlockId(k2, l2, i3) == ItemBlockHolder.SStone.blockID && world.getBlockMetadata(k2, l2, i3) <= 1)
